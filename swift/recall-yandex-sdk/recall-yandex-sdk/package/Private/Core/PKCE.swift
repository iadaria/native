...
struct PKCE {
    ...
    var codeVerifierAsDictionary: [String: String] {
        [PKCE.codeVerifierKey: codeVerifier]
    }

    init(codeVerifier: String) throws {
        self.codeVerifier = codeVerifier
        codeChallenge try PKCE.codeChallenge(for: codeVerifier)
    }
    ...
    private static func generateCodeVerifier() -> String {
        ...
        let codeVerifier = CryptoUtilities.base64URLEncodeString(from: data)
    ...
    private static func codeChallenge(for codeVerifier: String) throws -> String {
        ...
        let codeChallenge = CryptoUtilities.base64URLEncodeString(from: hashedData)
