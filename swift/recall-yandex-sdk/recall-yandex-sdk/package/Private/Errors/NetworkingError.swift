enum NetworkingError: YandexLoginSDKError {
    ...
    var message: String {
        ...
        case .couldntCreateJSONObjectFromData:
            ...
            """
        case let .absentTokenInJSON(jsonObject):
            message = """
        ...
        case let .invalidTokenType(tokenType):
            message = """
        ...
        case let .unknownRequestComponentsProviderType(type):
            message = """
        ...
        case let .invalidResponseType(type):
            message = """
        ...
        case let .couldntCreateURLFromString(string):
            ...
            - string: \(string)
            """
        case let .couldntCreateDataFromString(string):
            message = """
